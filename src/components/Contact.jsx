...
const Contact = () => {
 ...
 const [result, setResult] = React.useState("");
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "cf98c174-2db1-4a8e-a3a0-efcb3530b770");
...
<form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
    <div className='flex flex-wrap'>
        <div className='w-full md:w-1/2 text-left'>
            Your Name
            <input type="text" className='w-full border border-gray-300 rounded py-3 px-4 mt-4' placeholder='Your Name' name='Name' required />
        </div>
        <div className='w-full md:w-1/2 text-left md:pl-4'>
            Your Email
            <input type="email" className='w-full border border-gray-300 rounded py-3 px-4 mt-4' placeholder='Your Email' name='Email' required />
        </div>
    </div>
